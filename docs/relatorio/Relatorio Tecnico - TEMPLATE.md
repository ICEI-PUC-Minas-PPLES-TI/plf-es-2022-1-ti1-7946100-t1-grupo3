...
O relatório com as evidências dos testes de software realizados no sistema pode ser encontrado no seguinte link: <a href="[docs/relatorio/Evidências%20de%20Testes](https://github.com/brunomarquezine/CatDogAdote/tree/main/docs/Evidencias%20de%20testes)"> Evidências de Testes</a></span>
