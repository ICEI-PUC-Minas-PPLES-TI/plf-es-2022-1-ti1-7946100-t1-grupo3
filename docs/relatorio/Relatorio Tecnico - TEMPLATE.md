...
O relatório com as evidências dos testes de software realizados no sistema pode ser encontrado no seguinte link: <a href="docs/relatorio/Evidências de Testes"> Evidências de Testes</a></span>
